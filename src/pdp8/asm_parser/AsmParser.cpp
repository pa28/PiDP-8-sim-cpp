...
AsmParser::StatementsContext* AsmParser::statements() {
  ...
  try {
    ...
    do {
      ...
      | (1ULL << AsmParser::CLSI)
      | (1ULL << AsmParser::CLSM)
      | (1ULL << AsmParser::RAND))) != 0) || _la == AsmParser::CLRF
...
tree::TerminalNode* AsmParser::Dk8eaContext::CLRF() {
  return getToken(AsmParser::CLRF, 0);
}
...
std::vector<std::string> AsmParser::_symbolicNames = {
  ...
  "RIF", "RIB", "RMF", "CLSF", "CLEI", "CLDI", "CLSK", "CLSI", "CLSM", "RAND", 
  "CLRF", "Octal", "Decimal", "ID", "WS"
};
...
AsmParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x46, 0x19a, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 
    ...
    0x2, 0x43, 0x44, 0x3, 0x2, 0x3b, 0x42, 0x2, 0x191, 0x2, 0x98, 0x3, 0x2, 
    ...
    0x45, 0x2, 0x2, 0xb7, 0xd, 0x3, 0x2, 0x2, 0x2, 0xb8, 0xbd, 0x5, 0x14, 
